<template>
    <div class="contenedorPie">
      <h1>Gráfica de Productos Más Vendidos (Hoy)</h1> <!-- Título de la sección de la gráfica -->
  ...
  export default {
    name: 'InformesProductosHoy', // Nombre del componente
    data() {
      return {
    ...
    methods: {
      ...
      renderChart() {
        ...
        new Chart(ctx, {
          type: 'pie', // Tipo de gráfica: 'pie' para gráfica circular
          data: {
